...
label.setBounds(366, 111, 1000, 20);
...
String sql10 = "select * from eeedocs";
...
validate.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
    	if(count==8)
    	{
    		...
    		String sql11 = "select * from eeedocs";
    		PreparedStatement ps11 = MyConnection.getConnection().prepareStatement(sql11);
    		ResultSet rs11 = ps11.executeQuery();
    		try {
                FileWriter writer = new FileWriter("/home/athulatk/Desktop/Validations/EEE.txt", true);
                BufferedWriter bufferedWriter = new BufferedWriter(writer);
                bufferedWriter.write("Department Id : D04");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
                bufferedWriter.write("Department Name : Electrical and Electronics Engineering");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
