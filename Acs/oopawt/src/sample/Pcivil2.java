...
label.setBounds(450, 111, 1000, 20);
j1 = new JLabel("Progress:");
j1.setBounds(180, 154, 110, 30);
...
String sql10 = "select * from civildocs";
...
validate.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
    	if(count==8)
    	{
    		...
    		String sql11 = "select * from civildocs";
    		PreparedStatement ps11 = MyConnection.getConnection().prepareStatement(sql11);
    		ResultSet rs11 = ps11.executeQuery();
    		try {
                FileWriter writer = new FileWriter("/home/athulatk/Desktop/Validations/Civil.txt", true);
                BufferedWriter bufferedWriter = new BufferedWriter(writer);
                bufferedWriter.write("Department Id : D05");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
                bufferedWriter.write("Department Name : Civil Engineering");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
...
table_1_1.setRowSelectionAllowed(false);
table_1_1.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
table_1_1.setForeground(Color.BLACK);
table_1_1.setBackground(new Color(245, 245, 245));
table_1_1.setModel(model); 
table_1_1.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
table_1_1.setRowHeight(table_1_1.getRowHeight() + 25);
table_1_1.setFillsViewportHeight(true);

TableColumnModel columnModel = table_1_1.getColumnModel();
