...
label.setBounds(376, 111, 1000, 20);
...
String sql10 = "select * from csedocs";
...
validate.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
    	if(count==8)
    	{
    		...
    		String sql11 = "select * from csedocs";
    		PreparedStatement ps11 = MyConnection.getConnection().prepareStatement(sql11);
    		ResultSet rs11 = ps11.executeQuery();
    		try {
                FileWriter writer = new FileWriter("/home/athulatk/Desktop/Validations/CSE.txt", true);
                BufferedWriter bufferedWriter = new BufferedWriter(writer);
                bufferedWriter.write("Department Id : D01");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
                bufferedWriter.write("Department Name : Computer Science and Engineering");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
