...
label = new JLabel("Department of Computer Science and Engineering, ATK UNIVERSITY");
label.setBounds(350, 111, 1000, 20);
...
update.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
    	...
    	if(checkbox1.isSelected())
    	{
            	...
            	String sql = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 1";
    	...
    	else if(!checkbox1.isSelected())
    	{
        	...
        	String sql = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 1";
        	ps1 = MyConnection.getConnection().createStatement();
        	ps1.executeUpdate(sql);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox2.isSelected())
    	{
            	...
            	String sql2 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 2";
    	...
    	else if(!checkbox2.isSelected())
    	{
        	...
        	String sql2 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 2";
        	ps2 = MyConnection.getConnection().createStatement();
        	ps2.executeUpdate(sql2);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox3.isSelected())
    	{
            	...
            	String sql3 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 3";
    	...
    	else if(!checkbox3.isSelected())
    	{
        	...
        	String sql3 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 3";
        	ps3 = MyConnection.getConnection().createStatement();
        	ps3.executeUpdate(sql3);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox4.isSelected())
    	{
            	...
            	String sql4 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 4";
    	...
    	else if(!checkbox4.isSelected())
    	{
        	...
        	String sql4 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 4";
        	ps4 = MyConnection.getConnection().createStatement();
        	ps4.executeUpdate(sql4);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox5.isSelected())
    	{
            	...
            	String sql5 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 5";
    	...
    	else if(!checkbox5.isSelected())
    	{
        	...
        	String sql5 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 5";
        	ps5 = MyConnection.getConnection().createStatement();
        	ps5.executeUpdate(sql5);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox6.isSelected())
    	{
            	...
            	String sql6 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 6";
    	...
    	else if(!checkbox6.isSelected())
    	{
        	...
        	String sql6 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 6";
        	ps6 = MyConnection.getConnection().createStatement();
        	ps6.executeUpdate(sql6);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox7.isSelected())
    	{
            	...
            	String sql7 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 7";
    	...
    	else if(!checkbox7.isSelected())
    	{
        	...
        	String sql7 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 7";
        	ps7 = MyConnection.getConnection().createStatement();
        	ps7.executeUpdate(sql7);
        	}
        	catch(Exception ex)
    	...
    	if(checkbox8.isSelected())
    	{
            	...
            	String sql8 = "UPDATE csedocs SET `status` = 'Completed' WHERE `Sl.No` = 8";
    	...
    	else if(!checkbox8.isSelected())
    	{
        	...
        	String sql8 = "UPDATE csedocs SET `status` = 'Pending' WHERE `Sl.No` = 8";
        	ps8 = MyConnection.getConnection().createStatement();
        	ps8.executeUpdate(sql8);
        	}
        	catch(Exception ex)
...
clear.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
    	...
    	String sql1 = "SELECT `Status` FROM `csedocs`";
    	ps1 = MyConnection.getConnection().createStatement();
...
try
{ 
String sql = "select * from csedocs";
...
model.addRow(new Object[]{slno,name});
}
}
catch(Exception ex)
{
