...
label.setBounds(346, 111, 1000, 20);
...
String sql10 = "select * from ecedocs";
...
validate.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
    	if(count==8)
    	{
    		...
    		String sql11 = "select * from ecedocs";
    		PreparedStatement ps11 = MyConnection.getConnection().prepareStatement(sql11);
    		ResultSet rs11 = ps11.executeQuery();
    		try {
                FileWriter writer = new FileWriter("/home/athulatk/Desktop/Validations/ECE.txt", true);
                BufferedWriter bufferedWriter = new BufferedWriter(writer);
                bufferedWriter.write("Department Id : D03");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
                bufferedWriter.write("Department Name : Electronics and Communication Engineering");
                bufferedWriter.newLine();
                bufferedWriter.newLine();
